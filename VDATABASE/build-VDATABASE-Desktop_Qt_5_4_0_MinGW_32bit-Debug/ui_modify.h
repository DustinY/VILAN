...
public:
    ...
    void setupUi(QDialog *Modify)
    {
        ...
        textBrowser->setGeometry(QRect(110, 30, 271, 401));
        ...
        label->setGeometry(QRect(110, 10, 271, 20));
        pushButton_save = new QPushButton(Modify);
        pushButton_save->setObjectName(QStringLiteral("pushButton_save"));
        pushButton_save->setGeometry(QRect(170, 440, 75, 23));
        ...
        pushButton_2->setGeometry(QRect(280, 440, 75, 23));
        widget = new QWidget(Modify);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(0, 0, 531, 491));
        widget->setStyleSheet(QLatin1String("background-image: url(\"C:/Users/Dustin/Documents/School/CSULA/CS 437/VDATABASE/Docs/background.jpg\");\n"
""));
        widget->raise();
        textBrowser->raise();
        label->raise();
