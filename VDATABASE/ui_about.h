...
public:
    ...
    void setupUi(QDialog *About)
    {
        ...
        label->setGeometry(QRect(140, 70, 301, 71));
        QFont font;
        ...
        label_4->setGeometry(QRect(320, 380, 151, 31));
        label_5 = new QLabel(About);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(320, 350, 241, 31));
    ...
    void retranslateUi(QDialog *About)
    {
        ...
        label_5->setText(QApplication::translate("About", "<html><head/><body><p><span style=\" font-size:12pt; color:#ffffff;\">Vicken </span><span style=\" font-size:12pt; font-weight:600; color:#ffffff;\">Sarkis</span><span style=\" font-size:12pt; color:#ffffff;\"> Krikorian</span></p></body></html>", 0));
